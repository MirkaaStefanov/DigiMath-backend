...
import com.example.DigiMath_backend.repositories.PolinomRepository;
...
public class PolinomService {
    ...
    private final PolinomRepository polinomRepository;
    private final ModelMapper modelMapper;


    public PolinomDTO createPolinom(PolinomDTO polinomDTO) {
        Polinom polinom = modelMapper.map(polinomDTO, Polinom.class);
        return modelMapper.map(polinomRepository.save(polinom), PolinomDTO.class);

    }

    public PolinomDTO findById(Long id) throws ChangeSetPersister.NotFoundException {
        Polinom optionalPolinom = polinomRepository.findById(id).orElseThrow(ChangeSetPersister.NotFoundException::new);
        return modelMapper.map(optionalPolinom, PolinomDTO.class);
    }

    private String formatRoot(double chislo) {
    ...
    private String simplifyFraction(double number) {
    ...
    private List<String> uravnenieSDiskriminanta(List<Double> polinomCoef) {
    ...
    private List<String> solveReciprocalPolynomial(List<Double> polinomCoef) {
